...
export default class Define {
    ...
    public static designResolutionH: number = 1600;
    ...
    static viewUrl: string[] = ["MainView", "BattleView", "EditorView", "LoginView", "RankingView", "ExitView", "VictoryView",
        ...
        "InviteFriendView", "FeedHuaView", "FeedNiuView", "MusicView", "PuzzleView", "NoXinView", "RenWuView", "tiliPop"];
