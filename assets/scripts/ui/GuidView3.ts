...
@ccclass
export default class GuidView3 extends ViewBase {
    ...
    refreshView(isFristRefresh:boolean = false){
        ...
        TimeTaskManager.addTimeTask(delay,function(){
            ...
            block.destroy();
            Common.playSkeletonById(Define.skeleton_xinyindaoright,this.handNode,0,0,null,false,false);
